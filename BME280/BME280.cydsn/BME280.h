...
#define BME280_MAX_ITER 300    
#define P_SURFACE       101325 // Surface Pressure (Pascals); (Adjust to location)
    
#define BME280_I2C_MODE 0
#define BME280_SPI_MODE 1
...
//void BME280_readRegisterRegion(uint8_t*, uint8_t, uint8_t );
